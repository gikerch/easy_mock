...
definitions = {'definitions': {'Pet': {'required': ['id', 'name'], 'properties': {'id': {'type': 'integer', 'format': 'int64'}, 'name': {'type': 'string'}, 'tag': {'type': 'string'}}}, 'Entity': {'required': ['id', 'name'], 'properties': {'id': {'type': 'integer', 'format': 'int64'}, 'name': {'type': 'string'}, 'tag': {'type': 'string'}}}, 'Entities': {'type': 'array', 'items': {'$ref': '#/definitions/Entity'}}, 'Pets': {'type': 'array', 'items': {'$ref': '#/definitions/Pet'}}, 'Error': {'required': ['code', 'message'], 'properties': {'code': {'type': 'integer', 'format': 'int32'}, 'message': {'type': 'string'}}}}, 'parameters': {}}
...
validators = {
    ...
    ('ner_text', 'GET'): {'args': {'required': [], 'properties': {'text': {'description': 'How many items to return at one time (max 100)', 'required': False, 'type': 'integer', 'format': 'int32'}}}},
}
...
filters = {
    ...
    ('ner_text', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/Pets'}}},
}
